...
public class CharacterReplacable {
    ...
    public int characterReplacement(String s, int k) {
        ...
        for(int end = 0; end < s.length(); end ++){
            arr[s.charAt(end) - 'A']++;
            System.out.println((s.charAt(end) - 'A')+" "+s.charAt(end)+":"+arr[s.charAt(end) - 'A']);
            ...
            if(end - beg + 1 - largestCount > k){
                System.out.println((s.charAt(end) - 'A')+" inside "+s.charAt(end)+":"+arr[s.charAt(end) - 'A']);
    ...
    public static void main(String args[]){
        CharacterReplacable characterReplacable = new CharacterReplacable();
        System.out.println(" "+characterReplacable.characterReplacement("AABABBA",1));
    }
}
